...
$config['main_nav'] = array(
    ...
    'risk' => array('icon' => 'icon-doc', 'label' => 'Risk Process', 'sub_nav' => array(
            ...
            'risk/risk_identification_worksheet/worksheet' => array('icon' => 'icon-list', 'label' => 'Risk worksheet '),
            'risk/risk_identification_worksheet/worksheet_form' => array('icon' => 'icon-list', 'label' => 'Risk worksheet new '),
            'risk/risk_identification_worksheet/worksheetexample' => array('icon' => 'icon-list', 'label' => 'Risk worksheet 1'),
    ...
    'worksheet' => array('icon' => 'icon-settings', 'label' => 'Worksheet', 'sub_nav' => array(
      'worksheet/worksheet_header/index' => array('icon' => 'icon-list', 'label' => 'Worksheet'),
      'worksheet/worksheet_form/index' => array('icon' => 'icon-list', 'label' => 'Worksheet form'),
    )
    ),
    ...
    'acl' => array('icon' => 'icon-wrench', 'label' => 'Setting', 'sub_nav' => array(
      ...
      'acl/grade/index' => array('icon' => 'icon-share', 'label' => 'Grade Maping'),
		)
    )
);
