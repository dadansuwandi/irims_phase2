...
<html lang="en" class="no-js">
	...
	?>
		...
		<script src="<?php echo base_url('assets/helper/Helper.js') ?>"></script>
		<script src="<?php echo base_url('assets/helper/integration-helper.js') ?>"></script>
		<script>
