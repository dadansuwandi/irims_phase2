		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu page-sidebar-menu-light" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="sidebar-search-wrapper">
					...
					<!--
					<form class="sidebar-search " action="<?php /*echo site_url('welcome');*/ ?>" method="POST">
				...
				?>
				<li class="start <?php if (substr(uri_string(), 0, strlen($url)) == $url) echo 'active open'; ?>">
					<a href="javascript:;<?php echo $url?>">
					...
					?>
					<ul id="<?php echo $url?>" class="sub-menu">
				...
				-->
				<!-- END PAGE LAYOUTS MENU -->
				<!-- BEGIN UI FEATURES MENU -->
				<!--
				<li>
					<a href="javascript:;">
				...
				-->
				<!-- END UI FEATURES MENU -->
				<!-- BEGIN UI COMPONENTS MENU -->
				<!--
				<li>
					<a href="javascript:;">
