...
function nilaiskorkemungkinan(){
    debugger;
    if (($("#InherentRiskID_K_ID option:selected").val() == "") || ($("#InherentRiskID_D_ID option:selected").val() == "")) {
        alert("Ups, Silahkan isi nilai Inherent Risk !");
        return false;
    } else {
        $('#skor-kemungkinan-modal').modal('show');
...
$('#exco-effectiveness-question-form-kemungkinan').on('submit', function(e){
    ...
    // in row json object
    var urlPost = '<?php echo site_url('risk/risk_identification/getExcoEffectivenessValueCategoryByGroupValue'); ?>'; 
