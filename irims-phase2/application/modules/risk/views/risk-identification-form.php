							...
							<div class="tab-content">
								...
								<div class="tab-pane active" id="tab1">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<textarea class="form-control input-circle wysihtml5" required rows="6" id="OBJECTIVE" name="OBJECTIVE"><?php echo !empty($OBJECTIVE) ? $OBJECTIVE : ''; ?></textarea>
										</div>
									...
									<div class="form-group">
										...
										<span><i style="font-size:18px;color:#FBC02D" class="fa fa-info-circle" onclick="informationdetail('Program Kerja')"></i></span>
									</div>
									<div class="form-group">
										...
										<span><i style="font-size:18px;color:#FBC02D" class="fa fa-info-circle" onclick="informationdetail('Aktivitas')"></i></span>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Lingkup<span class="required">*</span></label>
										<div class="col-md-6">
											<textarea class="form-control input-circle wysihtml5" rows="6" name="SCOPE"><?php echo !empty($SCOPE) ? $SCOPE : ''; ?></textarea>
										</div>
										<span><i style="font-size:18px;color:#FBC02D" class="fa fa-info-circle" onclick="informationdetail('Lingkup')"></i></span>
									</div>
									<div class="form-group">
										...
										<span><i style="font-size:18px;color:#FBC02D" class="fa fa-info-circle" onclick="informationdetail('Kriteria')"></i></span>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Konteks Eksternal <span class="required">*</span></span></label>
										<div class="col-md-6">
										...
										<span><i style="font-size:18px;color:#FBC02D" class="fa fa-info-circle" onclick="informationdetail('Konteks Eksternal')"></i></span>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3">Konteks Internal <span class="required">*</span></span></label>
										<div class="col-md-6">
										...
										<span><i style="font-size:18px;color:#FBC02D" class="fa fa-info-circle" onclick="informationdetail('Konteks Internal')"></i></span>
									</div>
								</div>
								...
								<div class="tab-pane" id="tab2">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<!-- <input type="text" name="TREATMENT_DECISION_CATEGORY" value="<?php echo !empty($TREATMENT_DECISION_CATEGORY) ? $TREATMENT_DECISION_CATEGORY : ''; ?>" data-required="1" class="form-control input-circle"/>-->
										     <select class="form-control select2me" onchange="doSomething();"  id="TREATMENT_DECISION_CATEGORY_ddl">
														 <option value="">-- select  --</option>
														<option value="masih di perlukan pengendalian atas resiko yang ada">Manage</option>
														<option value="di tolak menghilangkan proses bisnis atau sasaran">Void</option>
														<option value="membuthkan bantuan pihak ke 3">Transfer</option>
														<option value="Diterima dengan existing control">Accept plus</option>
												</select> 
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<textarea class="form-control input-circle wysihtml5" rows="6" id="TREATMENT_DECISION_DESCRIPTION" name="TREATMENT_DECISION_DESCRIPTION"></textarea>
										</div>
									</div>
								...
								<div class="tab-pane" id="tab3">
									<div class="clonearea">
										...
										<div id="clone_<?php echo $count?>" class="form_list">
											...
											<div class="form-group">
		                                        <label class="control-label col-md-3">PIC (Unit Kerja) 2<span class="required">*</span></label>
		                                        <div class="col-md-6">
													<div class="input-group">
														<span class="input-group-addon input-circle-left"><i class="fa fa-user"></i></span>
										...
										<div id="clone_1" class="form_list">
											...
											<div class="form-group">
		                                        <label class="control-label col-md-3">PIC (Unit Kerja ) 3  <span class="required">*</span></label>
		                                        <div class="col-md-6">
													<div class="input-group">
														<span class="input-group-addon input-circle-left"><i class="fa fa-user"></i></span>
														<select class="form-control select2me" name="PIC_UNIT_KERJA_ID[]" data-required="1">
															<?php 
																//echo $this->risk_pic_model->get_dropdown_pic_unit($M->PIC_UNIT_KERJA_ID, $this->session->userdata('unit_id'), $this->session->userdata('pic_id'));	
																//var_dump('eeee'. $M->PIC_UNIT_KERJA_ID);die;
																echo $this->risk_pic_model->get_dropdown_pic_unit($M->PIC_UNIT_KERJA_ID, $this->session->userdata('unit_id'), $this->session->userdata('pic_id'));	
															?>
														</select>
													</div>
...
<div id="work-informasi-modal" class="modal fade">
...
function doSomething(){
	//alert('dd')
	debugger;
	//$('#TREATMENT_DECISION_DESCRIPTION').html('sssss')
	$("#TREATMENT_DECISION_DESCRIPTION").data("wysihtml5").editor.setValue($("#TREATMENT_DECISION_CATEGORY_ddl").val())
	//$('#TREATMENT_DECISION_DESCRIPTION').text($("#TREATMENT_DECISION_CATEGORY_ddl").val())
}
</script>
