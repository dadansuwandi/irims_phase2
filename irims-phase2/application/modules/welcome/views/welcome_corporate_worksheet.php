...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
Top Risk <small>Integrated Risk Management System (IRIMS)</small>
</h3>
<div class="page-bar">
...
<div class="row">
	...
	<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
		<a class="dashboard-stat green-meadow" href="#">
			<div class="visual">
				<i class="fa fa-file-o"></i>
			</div>
			<div class="details">
		...
		<div class="portlet light bordered">
			...
			<div class="portlet-body">
				<div class="tab-content">
					...
					<div class="tab-pane active" id="tab_rekapitulasi">
						...
						<table class="table table-striped table-bordered table-hover">
							<thead>
								<tr class="text-center">
									...
									<th colspan="10" bgcolor="8EA9DB">Hasil Risk Assessment (per Risk Category)</th>
								...
								<tr>
									<th colspan="5" bgcolor="8EA9DB">OPSTEK</th>
									<th colspan="5" bgcolor="8EA9DB">ADKOM</th>
								</tr>
				...
				<table class="table table-striped table-bordered table-hover">
					<thead>
						<tr align="center">
							...
							<td><b>DIREKTORAT/KP/KC/ANAK USAHA</b></td>
				...
				<table class="table table-striped table-bordered table-hover">
					<thead>
						<tr>
							...
							<th class="hidden-xs" rowspan="2">POTENSI BAHAYA (HAZARD)</th>
				...
				<table class="table table-striped table-bordered table-hover">
					<thead>
						<tr align="center">
							...
							<td><b>RISK REGISTER</b></td>
							<td><b>POTENSI BAHAYA (HAZARD)</b></td>
							<td><b>PENYEBAB</b></td>
							<td><b>DAMPAK</b></td>
							<td width="40px"><b>K</b></td>
							<td width="40px"><b>D</b></td>
