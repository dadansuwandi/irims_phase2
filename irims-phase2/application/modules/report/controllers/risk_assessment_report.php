<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
    ...
    /**
     * Risk Assessment Report Controller.
     * 
     * @package App
     * @category Controller
     * @author Jaya Dianto
     */
    class risk_assessment_report extends Admin_Controller {
        ...
        function index_pdf() {
            ...
            // $this->pdf->load_view('risk-assessment-report-list-pdf-adkom', $this->data);
            // $this->pdf->render();
			...
			if($risk_category_id == "1"){
				$this->pdf->load_view('risk-assessment-report-list-pdf-opstek', $this->data);				
			} else {
				$this->pdf->load_view('risk-assessment-report-list-pdf-adkom', $this->data);					
			}
            $this->pdf->render();
            ...
            // $this->load->view('risk-assessment-report-list', $this->data);
        }
        ...
        function owner() {
            ...
            /*Build View*/
            $this->template->build('risk-assessment-report-owner-list');
        }
        ...
        function owner_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a2', 'landscape');
            $this->pdf->load_view('risk-assessment-report-owner-list-pdf', $this->data);
            $this->pdf->render();
        ...
        function gm() {
            ...
            /*Build View*/
            $this->template->build('risk-assessment-report-gm-list');
        }
        ...
        function gm_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a2', 'landscape');
            $this->pdf->load_view('risk-assessment-report-gm-list-pdf', $this->data);
            $this->pdf->render();
        ...
        function officer() {
            ...
            /*Build View*/
            $this->template->build('risk-assessment-report-officer-list');
        }
        ...
        function officer_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a2', 'landscape');
            $this->pdf->load_view('risk-assessment-report-officer-list-pdf', $this->data);
            $this->pdf->render();
...
*/
            ...
            /*Build View*/
            $this->template->build('risk-assessment-report-head-list');
        }
        ...
        function head_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a2', 'landscape');
            $this->pdf->load_view('risk-assessment-report-head-list-pdf', $this->data);
            $this->pdf->render();
        ...
        function branch(){
            ...
            /*Build View*/
            $this->template->build('risk-assessment-report-branch-list');
        }
        ...
        function branch_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a2', 'landscape');
            $this->pdf->load_view('risk-assessment-report-branch-list-pdf', $this->data);
            $this->pdf->render();
