<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
     ...
     */
    class risk_map extends Admin_Controller {
        ...
        function __construct() {
            ...
            if ($this->input->post('cancel-button'))
                redirect('report/risk_map/index');
        }
        ...
        */
        ...
        function index_pdf() {
            ...
            $this->pdf->load_view('risk-map-list-pdf', $this->data);
            $this->pdf->render();
            ...
            $this->pdf->stream(date("Ymd")."_risk_map.pdf", array("Attachment"=>1));
        }
        ...
        function index_mitigated_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-mitgated-list-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_mitigated.pdf", array("Attachment"=>1));
        }
        ...
        function index_identification() {
            ...
            $this->template
                ...
                ->set_js_global('plugins/riskchart/riskchart')
                // <!-- END CORE ANGULARJS PLUGINS -->
                ->build('risk-map-identification-list');
        }
        ...
        function index_identification_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-identification-list-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_identification.pdf", array("Attachment"=>1));
        }
        ...
        function owner_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-list-owner-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_owner.pdf", array("Attachment"=>1));
        }
        ...
        function index_mitigated_owner() {
            ...
            $this->template
                ...
                ->set_js_global('plugins/riskchart/riskchart')
                // <!-- END CORE ANGULARJS PLUGINS -->
                ->build('risk-map-mitgated-list-owner');
        }
        ...
        function index_mitigated_owner_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-mitgated-list-owner-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_mitigated_owner.pdf", array("Attachment"=>1));
        }
        ...
        function gm_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-list-gm-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_gm.pdf", array("Attachment"=>1));
        }
        ...
        function index_mitigated_gm() {
            ...
            $this->template
                ...
                ->set_js_global('plugins/riskchart/riskchart')
                // <!-- END CORE ANGULARJS PLUGINS -->
                ->build('risk-map-mitgated-list-gm');
        }
        ...
        function index_mitigated_gm_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-mitgated-list-gm-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_mitigated_gm.pdf", array("Attachment"=>1));
        }
        ...
        function head_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-list-head-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_head.pdf", array("Attachment"=>1));
        }
        ...
        function index_mitigated_head() {
            ...
            $this->template
                ...
                ->set_js_global('plugins/riskchart/riskchart')
                // <!-- END CORE ANGULARJS PLUGINS -->
                ->build('risk-map-mitgated-list-head');
        }
        ...
        function index_mitigated_head_pdf() {
            ...
            /*Build View PDF*/
            $this->pdf->set_paper('a3', 'landscape');
            $this->pdf->load_view('risk-map-mitgated-list-head-pdf', $this->data);
            $this->pdf->render();
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-sanitize.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-touch.min.js');
            ...
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/plugins/ui-bootstrap-tpls.min.js');
            $this->pdf->set_base_path(base_url().'assets/global/plugins/angularjs/angular-risk-matrix.js');
            $this->pdf->stream(date("Ymd")."_risk_map_mitigated_head.pdf", array("Attachment"=>1));
        }
