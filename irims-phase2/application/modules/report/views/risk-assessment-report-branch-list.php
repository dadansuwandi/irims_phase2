	...
	<div class="portlet-body form">
		...
		<form action="" method="POST" class="horizontal-form">
					...
					<div class="col-md-4">
						<div class="form-group">
							...
							<select class="form-control select2me" name="status" required="required">
								...
								<option value="N" <?php echo $status==="N"?"selected='selected'":""?>>Teridentifikasi</option>
			...
			<div class="form-actions">
				...
				<a href="<?php echo site_url('report/risk_assessment_report/branch'); ?>" class="btn default">Reset</a> 
				<!-- <a href="<?php echo site_url('report/risk_assessment_report/branch_pdf?tahun='.$_POST['tahun'].'&status='.$_POST['status'].'&risk_category_id='.$_POST['risk_category_id']); ?>" class="btn red">Export to PDF<i class="fa fa-file-pdf-o"></i></a> -->
			</div>
		</form>
		<!-- END FORM-->
	</div>
	...
	<div class="portlet-body">
		<div class="overFlowTable">
			<table class="table table-striped table-bordered table-hover">
				<thead>
					<tr>
						<th class="hidden-xs" rowspan="2">NO1</th>
				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<?php } ?>
							<td><?php echo $this->unit_model->get_by_id($d->UNIT_ID)->name?></td>
							<td><a href="<?php echo site_url('report/risk_assessment_report/view/' . $d->RISK_IDENTIFICATION_ID . '/5'); ?>" target="_blank"><font color="blue"><?php echo $d->HAZARD?></a></font></td>
