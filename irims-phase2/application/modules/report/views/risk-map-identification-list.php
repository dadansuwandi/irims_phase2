...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="#">Risk Identification Map</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="#">Index</a>
	...
	<div class="portlet-body form">
		...
		<form action="" method="POST" class="horizontal-form">
			...
			<div class="form-actions">
				...
				<a href="<?php echo site_url('report/risk_map/index_identification'); ?>" class="btn default">Reset</a> 
				<!-- <a href="<?php //echo site_url('report/risk_map/index_identification_pdf?tahun='.$_POST['tahun']); ?>" class="btn red">Export to PDF<i class="fa fa-file-pdf-o"></i></a>  -->
	...
	$("#pdfDownloader").click(function(){
        ...
        html2canvas(document.getElementById("printDiv"), {
            onrendered: function(canvas) {
                ...
                doc.save($.now()+'_risk_map_identification_list.pdf');
            }
        });
