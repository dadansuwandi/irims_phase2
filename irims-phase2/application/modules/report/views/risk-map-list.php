	...
	<div class="portlet-body form">
		...
		<form action="" method="POST" class="horizontal-form">
			...
			<div class="form-actions">
				...
				<a href="<?php echo site_url('report/risk_map/index'); ?>" class="btn default">Reset</a> 
				<!-- <a href="<?php //echo site_url('report/risk_map/index_pdf?tahun='.$_POST['tahun']); ?>" class="btn red">Export to PDF<i class="fa fa-file-pdf-o"></i></a>  -->
...
<div id="printDiv" class="row">
	...
	<div class="col-md-6">
		...
		<div class="portlet box yellow">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-bar-chart-o"></i>Risk Maps
				</div>
				<!-- <div class="tools">
					<a href="javascript:;" class="collapse">
					</a>
...
<div id="risk-monitoring-modal" class="modal container fade">
				...
				<table class="table table-striped table-bordered table-hover">
					<thead>
						<tr align="center">
							...
							<td><b>RISK EVENT</b></td>
							<td><b>PENYEBAB</b></td>
							<td><b>DAMPAK</b></td>
							<td width="40px"><b>K</b></td>
							<td width="40px"><b>D</b></td>
							<td><b>PENGENDALIAN YANG SUDAH DILAKUKAN</b></td>
							<td><b>RENCANA MITIGASI</b></td>
							<td><b>PIC (UNIT KERJA)</b></td>
							<td><b>TARGET WAKTU</b></td>
						</tr>
					</thead>
	...
	$("#pdfDownloader").click(function(){
        ...
        html2canvas(document.getElementById("printDiv"), {
            onrendered: function(canvas) {
                ...
                doc.save($.now()+'_risk_map_list.pdf');
            }
        });
