	...
	<div class="portlet-body form">
		...
		<form action="" method="POST" class="horizontal-form">
			...
			<div class="form-actions">
				...
				<a href="<?php echo site_url('report/risk_map/index_mitigated_head'); ?>" class="btn default">Reset</a> 
				<!-- <a href="<?php //echo site_url('report/risk_map/index_mitigated_head_pdf?tahun='.$_POST['tahun']); ?>" class="btn red">Export to PDF<i class="fa fa-file-pdf-o"></i></a>  -->
...
<script>
	...
	function showEvent(risk_item_id){
		$.ajax({
            ...
            type: "POST",
            data: {risk_item_id:risk_item_id,type:"head"},
            dataType  : 'json',
