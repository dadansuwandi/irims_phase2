				...
				<table class="table table-striped table-bordered table-hover" id="sample_6">
					<thead>
						<tr>
							...
							<th style="text-align: center" class="hidden-xs">Start Date</th>
							<th style="text-align: center" class="hidden-xs">End Date</th>
...
<script>
	//jQuery(document).ready(function() {
        ...
        { "mDataProp" : "UserName","width":"30%"},
		{ "mDataProp" : "Role","width":"15%"},
		{ "mDataProp" : "start_date","width":"20%"},
		{ "mDataProp" : "end_date","width":"20%"},
        { "mDataProp" : "Actions"}
        ...
        success: function(data) {
			...
			var dtRisk = new Object();
				for (var i = 0; i < objdtRisk.length; i++) {
					...
					dtRisk.start_date =  moment(objdtRisk[i]["start_date"]).format("YYYY-MM-DD");
					dtRisk.end_date = moment(objdtRisk[i]["end_date"]).format("YYYY-MM-DD");;
