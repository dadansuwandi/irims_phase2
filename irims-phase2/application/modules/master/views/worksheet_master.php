...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo site_url('master/worksheet/header'); ?>">Worksheet Header</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
								...
								<table id="tblFRR01" class="table table-striped table-bordered table-hover" style="width: 100%;">
									<thead>
										<tr>
											...
											<td style="text-align: center">Active Form</td>
											<td style="text-align: center">Active Column</td>	
											<td style="text-align: center">sequence Form</td>
											<td style="text-align: center">sequence Column</td>
...
<script>
	...
	function loadDataHeader()
	{
		...
		var formData = new FormData();
			...
			var get_worksheetHeader_by_id = InvokeCodeBehind("worksheet","get_worksheetHeader_by_id", formData);
		debugger;
	...
	function rendertable(ID) {
			...
			$('#tbl' + ID).DataTable({
				...
				columns: [
					...
					{ data: 'sequencecolumn', orderable: false, defaultContent: "" },
					//{ data: 'FormActive', orderable: false, defaultContent: "" },
					{ data: 'LableName', orderable: false, defaultContent: "" },
					// { data: 'FRR01IDType', orderable: false, defaultContent: "" },

				//    { data: 'RoleName', orderable: false, defaultContent: "" },
				//    { data: 'LableName', orderable: false, defaultContent: "" },
					// { data: 'LableName', orderable: false, defaultContent: "" }
	...
	function LoadData(flowType,ID)
	{
		...
		var formData = new FormData();
			...
			var get_worksheetmaster_By_WorkSheetFlowID = InvokeCodeBehind("worksheet","get_worksheetmaster_By_WorkSheetFlowID", formData);
		debugger;
